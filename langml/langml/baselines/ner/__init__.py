...
def report_detail_metrics(model: Models, datas: List, id2label: Dict, is_bert: bool = True):
    all_preds, all_golds = [], []
    for token_ids, segment_ids, tags in datas:
        ...
        gold_tags = [id2label[i] for i in tags]
